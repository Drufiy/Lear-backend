...
| 14 | **Demo, recorded.** The §0b sequence, on a live cluster, captured as a shareable video | Everything | **IN PROGRESS 2026-08-11** — §0b's steps verified live individually (see §10), not yet chained in one continuous recorded run. Not done: still need a wedged-not-broken fixture to show restart_pod genuinely fixing something live, plus the actual recording. |
