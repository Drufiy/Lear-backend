...
export default function Notifications() {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight text-white mb-2">Notification Routing</h1>
        <p className="text-sm text-gray-400">Configure where Lear routes alerts, incidents, and telemetry digests.</p>
      </div>
